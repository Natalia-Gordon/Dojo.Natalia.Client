...
export class PaymentMethodsService {
  ...
  getMyPaymentMethods(): Observable<InstructorPaymentMethodDto[]> {
    return this.http.get<InstructorPaymentMethodDto[]>(`${this.apiUrl}${BASE}`, this.options());
  }
  ...
  getById(id: number): Observable<InstructorPaymentMethodDto> {
    return this.http.get<InstructorPaymentMethodDto>(`${this.apiUrl}${BASE}/${id}`, this.options());
  }
  ...
  create(request: CreateOrUpdatePaymentMethodRequest): Observable<InstructorPaymentMethodDto> {
    return this.http.post<InstructorPaymentMethodDto>(`${this.apiUrl}${BASE}`, request, this.options());
  }
  ...
  update(id: number, request: CreateOrUpdatePaymentMethodRequest): Observable<InstructorPaymentMethodDto> {
    return this.http.put<InstructorPaymentMethodDto>(`${this.apiUrl}${BASE}/${id}`, request, this.options());
  }

  /** DELETE /api/users/me/payment-methods/{id} — soft-delete (must belong to current user). */
  delete(id: number): Observable<void> {
    return this.http.delete<void>(`${this.apiUrl}${BASE}/${id}`, this.options());
  }
}
